      ...
      <form action="./main.do" method="post">
         <table  cellpadding="8"  style=" border-collapse:collapse; line-height:50px;" width="900px" >
            ...
            <tr style="font-size:18px;">
               ...
               <td class="border1" width="390px"><input type="text" class="input_text" size="19" name="id" value="${user.id }"></td>
               
            </tr>
            <tr style="font-size:18px;">
               <td class="border1"> 성 명</td>
               <td class="border1"><input type="text" class="input_text" size="19" name="username" value="${user.name }"></td>
            </tr>
            <tr  style="font-size:18px; line-height:22px;" >
               <td class="border1"  rowspan="3"> 주  소</td>
               <td ><input type="text" class="input_text" size="3" name="zip1" value="${firstPost[0]}"> - <input type="text" class="input_text" size="3" name="zip2" value="${firstPost[1]}"></td>
            </tr> 
            <tr style="font-size:18px; line-height:22px;" >
            ...
            <tr style="font-size:18px;">
               ...
               <td class="border1"><input type="text" name="phone"  size="5" class="input_text" value="${firstPhone[0] }">
