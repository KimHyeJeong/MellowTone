...
<body>
   <center>
      <form method="post" action="mypage.do?action=success_id" name="Sfrm">
         <table cellpadding="8" cellspacing="0"
            ...
            <tr>
               <td width="360px" align="right">성명</td>
            ...
            <tr>
               ...
               <td><input type="text" class="input_text" size="40"
                  name="email">&nbsp; <input type="button" class="button2" value="인증번호 받기"
                  onclick="num_check()"></td>
            </tr>
            <tr>
            ...
            <tr>
               <td height="50px" colspan="2" align="center"><input type="submit" value="확인"
                  class="button1"> &nbsp;<input type="reset" value="취소"
                  onclick="cancel()" class="button1"></td>
            </tr>
            <tr height="200px"></tr>
         </table>
      </form>
